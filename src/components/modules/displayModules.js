    ...
    <>
      ...
      <div className="tech-row-lower">
        {(item.level === 0 && <span className="tech-text">I do not yet have functional knowledge of {item.title}. </span>) ||
          ...
          (item.level === 4 && <span className="tech-text">I am comfortable and experienced working with {item.title} in a variety of contexts. </span>) ||
    ...
    <>
      ...
      <div className="row proj-row-lower">
        <div className="col-sm-5">
          ...
          {item.frontCode !== 0 && item.frontCode.length > 0 ? (
            <p>
              <a href={item.frontCode} target="_blank" rel="noreferrer">
                <strong>Client Code on GitHub</strong>
              </a>
            </p>
          ) : null}
          {item.backCode !== 0 && item.backCode.length > 0 ? (
            <p>
              <a href={item.backCode} target="_blank" rel="noreferrer">
                <strong>Backend Code on GitHub</strong>
              </a>
            </p>
          ) : null}
        </div>
