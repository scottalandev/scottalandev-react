...
export const about = {
  ...
  developer:
    'Web development has been a natural transition for me, after numerous prior experiences of being the individual assigned to "just figure it out" when some technical need arose with nobody in the organization able to meet the challenge. It was by that process that I built my first several websites for organizations I was a key member of. Those early sites were built with very little coding--I used squarespace, wix, and several different wordpress approaches--but I found that I really enjoyed the logical challenge and value of precision that I encountered in those experiences. When it came time for change, I engaged myself in truly learning the craft and technique of web development and am proud of my accomplishments and progress to date.',
